...
const HipLogin = () => {
    ...
    return (
        <div className="container d-flex flex-column align-items-center p-5">
            <h3 className="fw-bold font-blue">Hospital Admin Login</h3>
            {/* <label for="exampleFormControlInput1" class="form-label">Enter Mobile Number</label> */}
            <hr style={{ width: '300px' }} />

            <img className='my-5 w-25' src={hospitalImg} />

            <label for="basic-url" className="form-label fw-bold">Enter Hospital Admin ID:</label>
            ...
            <div className='w-50 text-center mt-3'>
                <div className='d-flex justify-content-center'>
                    <span className='me-3'>Create Hospital Admin ID:</span>
